// Type definitions for stakhanov 0.6.1
// Project: stakhanov
...
declare module Stakhanov {
    export function createWorkers(handlers: Stakhanov.Handler[], config: Stakhanov.Config, options?: Stakhanov.Options): Stakhanov.Process
}
